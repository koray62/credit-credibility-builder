      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-8 mb-10 lg:mb-0">
            ...
            <div className="mt-8 p-4 bg-white rounded-lg shadow-sm border border-gray-100 animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <p className="text-gray-700 flex items-center">
                ...
                <span><strong>Güvenilir süreç:</strong> Bu site bir dolandırıcılık değildir. Tüm işlemler anlaşmalı bankalar üzerinden yapılmaktadır.</span>
              </p>
            </div>
          </div>
          ...
          <div className="lg:w-1/2 relative animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="absolute -top-4 -right-4 bg-secondary text-white py-2 px-4 rounded-lg shadow-md transform rotate-3 hidden md:block">
              <span className="font-medium">Ödenen Komisyon Dışında 0₺ Maliyet!</span>
            </div>
          </div>
        </div>
      </div>
