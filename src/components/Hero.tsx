        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 lg:pr-8 mb-10 lg:mb-0">
            ...
            <p className="text-gray-700 text-lg md:text-xl mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
              SkorUp avantaj programı sayesinde Findeks notunuz pek çok farklı alanda size özel avantajlar sunuyor. SkorUp ile kredi puanınızı güvenli, risksiz ve ücretsiz bir şekilde oluşturmaya başlayın. Aramıza katılın, kredi notunun hayatınıza katacağı avantajlardan faydalanın.
            </p>
